...
SQLCMD="gsqlnet test test --dsn=G4N2"
...
{
$SQLCMD << EOF
select to_char(systimestamp,'YYYY/MM/DD HH24:MI:SS.FF6') ||' CALL_EXECUTE = '||nvl(sum(VALUE),0) from X\$SQL_SYSTEM_INFO where NAME = 'CALL_EXECUTE' ;
EOF
}
